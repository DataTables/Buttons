...
export interface ElStruct {
	className: string;
	tag: string;
}

export interface ButtonDom extends ElStruct {
	active: string;
	disabled: string;
	dropClass: string;
	dropHtml: string;
...
export interface ButtonsKeyboardEvent extends KeyboardEvent {
...
type FunctionButtonCustomizeZip = (
	zip: any,
	data: ButtonsApiExportDataReturn,
	filename: string
) => void;

export interface DefaultsButtons {
	name: string;
	tabIndex: number;
	buttons: ButtonsList;
