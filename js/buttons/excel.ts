...
import DataTable, { Dom, HeaderStructure, util } from 'datatables.net';
import '../interface';
...
export const excel: ButtonFunction = function (dt, conf) {
	if (
		typeof DataTable.ext.buttons.excelHtml5 === 'object' &&
...
// Excel (xlsx) export
//
export const excelHtml5: ButtonConfig = {
