...
export const colvis: FunctionButton = function (dt, conf) {
	var node: null | Dom = null;
	var buttonConf = {
		extend: 'collection',
		init: function (dt: Api, n: Dom) {
			node = n;
		},
		text: function (dt: Api) {
...
export const columnsToggle: FunctionButton = function (dt, conf) {
	var columns = dt
		.columns(conf.columns)
		.indexes()
		.map(function (idx) {
...
export const columnToggle: FunctionButton = function (dt, conf) {
	return {
...
export const columnsVisibility: FunctionButton = function (dt, conf) {
	var columns = dt
		.columns(conf.columns)
		.indexes()
		.map(function (idx) {
...
export const columnVisibility: ButtonConfig = {
	...
	_columnText: function (dt: Api, conf: ButtonConfig) {
...
export const colvisRestore: ButtonConfig = {
...
export const colvisGroup: ButtonConfig = {
